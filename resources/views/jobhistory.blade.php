...
@section('content')
<!--- Profile Form --->
	<form action="jobHistory" method="POST" style="background-color: #eaeaea;height: 440px;margin: 0px; width: 600px; border-radius: 10px">
	...
	<tr>
	<td>Description:</td>
	<td><textarea rows="4" cols="50" name="description"></textarea>{{ $errors->first('description')}}</td>
	</tr>
